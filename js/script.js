...
document.addEventListener("DOMContentLoaded", function() {
  const playPauseButton = document.querySelector('.play-pause span');
  const rippleLayers = document.querySelectorAll('.ripple-layer');
  ...
  playPauseButton.addEventListener('click', function() {
    if (isPlaying) {
      // Pause
      rippleLayers.forEach(layer => layer.classList.remove('ripple-active'));
      playPauseButton.textContent = 'play_arrow';
    } else {
      // Play
      rippleLayers.forEach(layer => layer.classList.add('ripple-active'));
